...
data = {}
savetime = input("What hour would you like the daily log to be saved? (example: 12 (for 12), 13 for 1300, 8 for 0800): ") 
data['savetime'] = int(savetime)
print("NOTE: Com Port can be found in Windows Control Panel, Devices and Printers ")
...
for x in range(0,int(numchannels)):
    ...
    channel['type'] = input(("{} - Type (supply, return, or ssdg): ").format(x))
